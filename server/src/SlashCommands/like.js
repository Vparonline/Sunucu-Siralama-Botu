...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("oyver")
        .setDescription("Sunucuya +1 oy verirsin"),
        ...
        if (!timedb) {
            ...
            interaction.reply({
                embeds: [new EmbedBuilder()
                    ...
                    .setFooter({
                        text: "Sunucunuzu geniş kitlelere duyurabilmenizi sağlayan bir platformdur.",
                        iconURL: interaction.guild.iconURL({ dynamic: true })
                    })
                    .setThumbnail(interaction.guild.iconURL({ dynamic: true, size: 1024 }))
                    .setDescription(`
Toplam oy : **${totalLike + 1}**
Bu zamana kadar **${likeCount}** oy kullanıdınız.      
                    `)
                ]
            })
            ...
            timedb.save()
            interaction.reply({ content: `<:chavocarpi:1073974190698418216> Bugün oy kullanıdınız. Lütfen yarını bekleyiniz.`, ephemeral: true })
        } else {
            var likeCount = timedb ? timedb.likeCount : 1;
            ...
            if (timeLike >= 7200000) {
                ...
                interaction.reply({
                    embeds: [new EmbedBuilder()
                        ...
                        .setDescription(`
Toplam Oy : **${totalLike + 1}**
Bu zamana kadar **${likeCount}** oy kullandınız.         
                        `)
                    ]
                })
                await check(interaction.member.id, interaction.guild.id)
