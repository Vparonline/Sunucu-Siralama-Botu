<template>
  <div id="app">
    <br><br><br><br><br>
    <h1 class="title" style="text-align:center;">SUNUCU <br> SIRALAMASI</h1>


    <ul id="ort" style="list-style-type:none;margin-top: -1%;">
      <center>
        <div class="kutu" style=" margin-top: 220px !important;" >
          <button class="button" @click="servers('Public')"><i class="fas fa-globe-americas"></i> &nbspPublic</button>
          <button class="button" @click="servers('Sohbet')"><i class="absolute fal fa-globe"></i> &nbspSohbet</button>
          <button class="button" @click="servers('Oyun')"><i class="absolute fal fa-gamepad"></i> &nbspOyun</button>
          <button class="button" @click="servers('Doğrulanmamış')"><i class="absolute fal fa-times"></i> &nbspDoğrulanmamış</button>
        </div>
      </center>
      <br><br>
      <center>
        <li style="margin:auto;" v-for="(guild, index) in sırala" :key="index">
          <div class="guildlist" @click="searchFunction(guild.guildID)">
            ...
            <h1 class="voiceCount">{{ guild.count }} <i class="fas fa-microphone"></i></h1>
          </div>
        </li>
      </center>
    </ul>
